...
public class Dev {
    ...
    public void inscreverBootCamp(Bootcamp bootcamp){
        ...
        bootcamp.getDevsInscritos().add(this); // adicionar dev ao bootcamp;
    }
    ...
    public void setConteudosInsctitos(Set<Conteudo> conteudosInsctitos) {
        this.conteudosInscritos = conteudosInsctitos;
    }
